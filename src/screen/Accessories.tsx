  ...
  const products = [
    {
      id: 1,
      name: "DreamChill",
      description: "Cooling Mattress Protector",
      price: "$219.99",
      image: "/image-2.png", // Placeholder path
    },
    {
      id: 2,
      name: "Blu Sleep Ghetti Pillow",
      description: "Stay Fresh, Cool, and Comfortable",
      price: "$79",
      image: "/image-1.png", // Placeholder path
    },
    {
      id: 3,
      name: "Blu Sleep Otsuni Sheet Set",
      description: "Comfort & Insulation",
      price: "$559",
      image: "/image-4.png", // Placeholder path
    },
  ];
  ...
  return (
    <div className="min-h-screen w-screen bg-[linear-gradient(180deg,rgb(0,5,63)_0%,rgb(93.62,132.53,168.94)_100%)] flex flex-col items-center py-12">
      ...
      <h1 className="text-5xl font-bold text-white text-center mb-16 tracking-normal leading-[46.8px]">
        Based on your build, we suggest these:
      </h1>
